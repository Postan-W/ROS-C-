...
(cl:defmethod cl:initialize-instance :after ((m <Student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hello_msgs-msg:<Student> is deprecated: use hello_msgs-msg:Student instead.")))
...
(cl:defmethod age-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello_msgs-msg:age-val is deprecated.  Use hello_msgs-msg:age instead.")
  (age m))
